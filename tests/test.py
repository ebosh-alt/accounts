...
async def new_data():
    await accounts.new(Account(id=0, shop="Goggle", price=100.0, description="description1", data=datetime.datetime.now(), view_type=True,
                         name="name1"))
    await accounts.new(Account(shop="Facebook", price=110.0, description="description2", data=datetime.datetime.now(), view_type=True,
                         name="name2"))
    await accounts.new(Account(shop="Amazon", price=120.0, description="description3", data=datetime.datetime.now(), view_type=True,
                         name="name3"))
    await accounts.new(Account(shop="Apple", price=130.0, description="description4", data=datetime.datetime.now(), view_type=True,
                         name="name4"))
    await accounts.new(Account(shop="Uber", price=140.0, description="description5", data=datetime.datetime.now(), view_type=True,
                         name="name5"))
    await accounts.new(Account(shop="Goggle", price=150.0, description="description6", data=datetime.datetime.now(), view_type=True,
                         name="name6"))
    ...
    await sellers.new(Seller(id=SELLER, rating=4, balance=4, username="username4"))
